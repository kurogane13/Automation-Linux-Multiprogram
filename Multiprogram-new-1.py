...
while (loop==0):
    ...
    print("Mode 1 - RUNS A GNOME TERMINAL SESSION")
    print("Mode 2 - RUNS LINUX TERMINAL COMMANDS - INVOKES TERMINAL FROM WITHIN THIS PROGRAM  ")
    print("Mode 3 - MANAGE FILES AND FOLDERS ")
    print("Mode 4 - FIND REGULAR EXPRESSION PATTERNS IN FILES")
    print("Mode 5 - COPY THIS ENTIRE PROGRAM AND FILES, TO A LOCAL DIRECTORY OR A REMOTE HOST VIA SCP")
    print("Mode 6 - TRANSFER FILES/FOLDERS TO A REMOTE HOST VIA SCP PROTOCOL")
    print("Mode 7 - GETS LINUX SYSTEM DETAILED REPORT")
    print("Mode 8 - DEBUGS USB PLUG AND PLAY DEVICES")
    print("Mode 9 - ACCESSES LINUX UPDATE MODES")
    print("Mode 10 - MONITORING MODES - VIEW PROCESSES, SERVICES STATUS AND LOGS")
    print("Mode 11 - STARTS THIS PROGRAM IN ANOTHER TERMINAL")
    print("------------------------------------------------------------------------------------")
    print("NETWORK CONTROL MODE OPERATIONS")
    print("------------------------------------------------------------------------------------")
    print("Mode 12 - RELOADS ALL NETWORK INTERFACES AND LOGS INFO TO A FILE")
    print("Mode 13 - DISPLAYS CURRENT IP CONFIGURATION AND LOGS INFO TO A FILE")
    print("Mode 14 - SCANS YOUR LAN WITH IPSCAN TOOL")
    print("Mode 15 - MONITORS LAN NETWORK BANDWIDTH")
    print("Mode 16 - CREATE AUTOMATION SCRIPTS TO GET CISCO ROUTERS RUNNING CONFIG AND/OR CHECK NETWORK STATUS")
    print("Mode 17 - RUN SCRIPTS CREATED IN PREVIOUS MODE, OR PLACED IN TELNET OR SSH DIRECTORIES")
    print("Mode 18 - ACCESSES A CISCO LAB DEVICE ROUTER/L3 DEVICE TO OBTAIN ACTUAL NETWORK STATUS")
    print("------------------------------------------------------------------------------------")
    print("Mode 19 - SYSTEM REBOOT OR SHUTDOWN MENU - SHUTS DOWN OR RESTARTS SYSTEM")		
    print("------------------------------------------------------------------------------------")
    ...
    filesandfolders=("3")
    regularexpression=("4")
    copyprogramlocalorremote=("5")
    transferviascp=("6")
    linuxsysteminfo=("7")
    debugsusbplugandplay=("8")
    updatemodes=("9")
    monitoringmodes=("10")
    anotherterminal=("11")
    
    
    reloadnetworkints=("12")
    currentipconfig=("13")
    scansyourlan=("14")
    monitornetwork=("15")
    createciscorouterscripts=("16")
    runscripts=("17")
    accessciscodevicelab=("18")
    ...
    if modeselection==conversionmode:
        ...
        while (loop==120):
            ...
            import os
            os.system('clear')
            os.system('python /home/input-terminal-commands.py')
        ...
        while (loop==29):
            ...
            os.system('clear')
            print("----------------------------------------------------------------------------------")
            print("CISCO LAB DEVICE ACCESS MODE ENTERED...")
            print("----------------------------------------------------------------------------------")
        ...
        while (loop==95):
            ...
            os.system('clear')
            print("----------------------------------------------------------------------------------")
            print("SHELL SCRIPT CREATION FOR CISCO ROUTERS MODE ACCESSED...")
            print("----------------------------------------------------------------------------------")
        ...
        while(loop==118):
            ...
            os.system('clear')
            print("------------------------------------------------------------------------------------------------")
            print("RUN SCRIPTS MODE ACCESSED")
            print("------------------------------------------------------------------------------------------------")
        ...
        while (loop==119):
            ...
            os.system('clear')
            print("--------------------------------------------------------------------------------------------------")
            print("THIS MODE WILL FIND A REGULAR EXPRESSION IN A TEXT FILE, AND CREATE A TXT FILE AFTER WITH ITS NAME")
            print("--------------------------------------------------------------------------------------------------")
            print("'1' - TO START SRCIPT NOW")
            print("'0' - TO RETURN TO MAIN MENU")
            print("--------------------------------------------------------------------------------------------------")
            loop = 120
            while (loop==120):
                
                proceedwithregular=raw_input("WAITING FOR USER INPUT: ")
                returntomainfromregular=("0")
                startscriptnow=("1")
                if proceedwithregular==returntomainfromregular:
                ...
                elif proceedwithregular==startscriptnow:
                    ...
                    while (loop==121):
                        ...
                        relaunchregularprogram=raw_input("WANT TO RE-LAUNCH THE PROGRAM AGAIN: 'y/n'? ")
                        reluanchprogramyes=("y")
                        relaunchprogramno=("n")
                        if relaunchregularprogram==reluanchprogramyes:
                            import os
                            os.system('clear')
                            loop = 119

                        elif relaunchregularprogram==relaunchprogramno:
                            import os
                            os.system('clear')
                            print("RETURNING TO MAIN MENU...")
                            import time
        ...
        while (loop==80):
            ...
            if all_loging==returntomainmenuornot:
                  ...
                  print("------------------------------------------------------------------------------------------------")
                  os.system('ls -t -l -h /home/$USER/loggingfromterminal.log')
                  print("------------------------------------------------------------------------------------------------")
                  ...
                  if viewloggingfileornot==donotviewlogfile:
                      ...
                      import os
                      os.system('clear')
                      os.system('sudo gedit /home/$USER/loggingfromterminal.log')
                      import time
                      time.sleep(1)
                      loop = 81
                      while (loop==81):
