...
while (loop==0):
    ...
    print("Mode 1 - INVOKE LINUX TERMINAL FROM THIS MODE")
    print("Mode 2 - MANAGE FILES AND FOLDERS ")
    print("Mode 3 - FIND REGULAR EXPRESSIONS IN FILES")
    print("Mode 4 - COPY THIS ENTIRE PROGRAM AND FILES, TO A LOCAL DIRECTORY OR A REMOTE HOST VIA SCP")
    print("Mode 5 - TRANSFER FILES/FOLDERS TO A REMOTE HOST VIA SCP PROTOCOL")
    print("Mode 6 - GETS LINUX SYSTEM DETAILED REPORT")
    print("Mode 7 - DEBUGS USB PLUG AND PLAY DEVICES")
    print("Mode 8 - ACCESSES LINUX UPDATE MODES")
    print("Mode 9 - MONITORING MODES - VIEW PROCESSES, SERVICES STATUS AND LOGS")
    print("------------------------------------------------------------------------------------")
    print("NETWORK CONTROL MODE OPERATIONS")
    print("------------------------------------------------------------------------------------")
    print("Mode 10 - RELOADS ALL NETWORK INTERFACES AND LOGS INFO TO A FILE")
    print("Mode 11 - DISPLAYS DETAILED IP NETWORK AND HARDWARE INFO, AND LOGS OUTPUT TO A FILE")
    print("Mode 12 - SCANS YOUR LAN WITH NMAP TOOL")
    print("Mode 13 - MONITORS LAN NETWORK BANDWIDTH")
    print("Mode 14 - CREATE AUTOMATION SCRIPTS TO GET CISCO ROUTERS RUNNING CONFIG AND/OR CHECK NETWORK STATUS")
    print("Mode 15 - RUN SCRIPTS CREATED IN PREVIOUS MODE, OR PLACED IN TELNET OR SSH DIRECTORIES")
    print("Mode 16 - ACCESSES A CISCO LAB DEVICE ROUTER/L3 DEVICE TO OBTAIN ACTUAL NETWORK STATUS")
    print("------------------------------------------------------------------------------------")
    print("Mode 17 - SYSTEM REBOOT OR SHUTDOWN MENU - SHUTS DOWN OR RESTARTS SYSTEM")		
    print("------------------------------------------------------------------------------------")
    print("'s' - TO SWITCH THIS PROGRAM TO COLORED MODE - ")
    print("------------------------------------------------------------------------------------")
    print("TO EXIT THIS PROGRAM JUST TYPE: exit, AND HIT ENTER")
    print("####################################################################################")

    print("Enter  operation mode (example: for mode 0, type 0) and hit enter -")
    print("------------------------------------------------------------------------------------")
    ...
    elif modeselection==switchtocoloredmode:
        import os
        os.system('python /home/Multiprogram-new-1-server-colored.py')
        os.system('clear')
        break
        ...
        while (loop==80):
            ...
            if all_loging==returntomainmenuornot:
                  ...
                  if viewloggingfileornot==donotviewlogfile:
                      ...
                      import os
                      os.system('clear')
                      os.system('cat /home/$USER/loggingfromterminal.log')
                      import time
                      time.sleep(1)
                      loop = 81
                      while (loop==81):
